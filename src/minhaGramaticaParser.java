...
public class minhaGramaticaParser extends Parser {
	...
	public static class Declaracao_varContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof minhaGramaticaListener ) ((minhaGramaticaListener)listener).enterDeclaracao_var(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof minhaGramaticaListener ) ((minhaGramaticaListener)listener).exitDeclaracao_var(this);
		}
	}
	...
	public final ComandosContext comandos() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16786588L) != 0)) {
				{
				{
				setState(105);
				comando();
	...
	public final ExpressaoContext expressao() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==OP_ARIT || _la==OP_CONCAT) {
				{
				{
				setState(203);
				_la = _input.LA(1);
				if ( !(_la==OP_ARIT || _la==OP_CONCAT) ) {
